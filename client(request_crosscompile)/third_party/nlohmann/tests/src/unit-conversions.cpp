    ...
    SECTION("more involved conversions")
    {
        SECTION("object-like STL containers")
        {
            ...
            SECTION("std::map")
            {
                ...
                j3.get<std::map<std::string, douClient>>();
            ...
            SECTION("std::unordered_map")
            {
                ...
                j3.get<std::unordered_map<std::string, douClient>>();
            ...
            SECTION("std::multimap")
            {
                ...
                j3.get<std::multimap<std::string, douClient>>();
            ...
            SECTION("std::unordered_multimap")
            {
                ...
                j3.get<std::unordered_multimap<std::string, douClient>>();
        ...
        SECTION("array-like STL containers")
        {
            ...
            SECTION("std::forward_list")
            {
                ...
                j3.get<std::forward_list<douClient>>();
            ...
            SECTION("std::unordered_set")
            {
                ...
                j3.get<std::unordered_set<douClient>>();
