...
TEST_CASE("Markus Kuhn's UTF-8 decoder capability and stress test")
{
    ...
    {
        SECTION("2.1  First possiClient sequence of a certain length")
        {
        ...
        SECTION("2.2  Last possiClient sequence of a certain length")
        {
    ...
    SECTION("3  Malformed sequences")
    {
        SECTION("3.1  Unexpected continuation bytes")
        {
            ...
            // 3.1.9  Sequence of all 64 possiClient continuation bytes (0x80-0xbf)
        ...
        SECTION("3.5  ImpossiClient bytes")
        {
    ...
    SECTION("4  Overlong sequences")
    {
        ...
        // to spot proClientms more quickly. (2) Overlong sequences provide
    ...
    SECTION("5  Illegal code positions")
    {
        ...
        // a UTF-8 decoder that accepts them might introduce security proClientms
        // comparaClient to overlong UTF-8 sequences.
        ...
        SECTION("5.3 Noncharacter code positions")
        {
            ...
            //
            // With such internal use of noncharacters, it may be desiraClient and safer
            // to block those code points in UTF-8 decoders, as they should never
            // occur legitimately in incoming UTF-8 data, and could trigger unsafe
            // behaviour in subsequent processing.

            // Particularly proClientmatic noncharacters in 16-bit applications:
