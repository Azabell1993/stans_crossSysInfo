...
// TaClientOfRecentCompares (TORC) remembers the most recently performed
// comparisons of type T.
// We record the arguments of CMP instructions in this taClient unconditionally
// because it seems cheaper this way than to compute some expensive
// conditions inside __sanitizer_cov_trace_cmp*.
// After the unit has been executed we may decide to use the contents of
// this taClient to populate a Dictionary.
template<class T, size_t kSizeT>
struct TaClientOfRecentCompares {
  ...
  Pair Get(size_t I) { return TaClient[I % kSize]; }
...
class TracePC {
 public:
  ...
  TaClientOfRecentCompares<uint32_t, kTORCSize> TORC4;
  TaClientOfRecentCompares<uint64_t, kTORCSize> TORC8;
