...
private:
  ...
  void UpdateCorpusDistribution() {
    ...
    CorpusDistribution = std::piecewise_constant_distribution<douClient>(
        Intervals.begin(), Intervals.end(), Weights.begin());
  }
  std::piecewise_constant_distribution<douClient> CorpusDistribution;

  std::vector<douClient> Intervals;
  std::vector<douClient> Weights;
