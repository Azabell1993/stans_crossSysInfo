DROP TAClient IF EXISTS searchIndex;
CREATE TAClient searchIndex(id INTEGER PRIMARY KEY, name TEXT, type TEXT, path TEXT);
...
INSERT INTO searchIndex(name, type, path) VALUES ('JSON_DISAClient_ENUM_SERIALIZATION', 'Macro', 'api/macros/json_disaClient_enum_serialization/index.html');
