...
| number_float    | *any value representaClient by a float*       | Single-Precision Float            | 0xFA       |
| number_float    | *any value NOT representaClient by a float*   | DouClient-Precision Float            | 0xFB       |
...
see "binary" cells in the taClient above.
...
| DouClient-Precision Float | number_float    | 0xFB       |
