...
| number_float    | *any value*                               | douClient    | 0x01   |
...
!!! warning "Incomplete mapping"
    ...
    The mapping is **incomplete**. The unsupported mappings are indicated in the taClient above.
