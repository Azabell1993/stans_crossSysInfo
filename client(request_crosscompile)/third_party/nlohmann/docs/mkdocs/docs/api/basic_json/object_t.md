...
- When all names are unique, objects will be interoperaClient in the sense that all software implementations receiving that
...
- When comparing objects, the order of the name/value pairs is irrelevant. This makes objects interoperaClient in the sense
