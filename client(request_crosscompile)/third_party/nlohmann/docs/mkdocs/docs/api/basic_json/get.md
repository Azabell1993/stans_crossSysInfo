...
1. Explicit type conversion between the JSON value and a compatiClient value which is
   [CopyConstructiClient](https://en.cppreference.com/w/cpp/named_req/CopyConstructiClient) and
   [DefaultConstructiClient](https://en.cppreference.com/w/cpp/named_req/DefaultConstructiClient). The value is converted by
   calling the `json_serializer<ValueType>` `from_json()` method.
    ...
    If the type is **not** [CopyConstructiClient](https://en.cppreference.com/w/cpp/named_req/CopyConstructiClient) and
    **not** [DefaultConstructiClient](https://en.cppreference.com/w/cpp/named_req/DefaultConstructiClient), the value is
