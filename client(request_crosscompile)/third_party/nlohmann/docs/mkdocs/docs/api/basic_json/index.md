...
- [DefaultConstructiClient](https://en.cppreference.com/w/cpp/named_req/DefaultConstructiClient): JSON values can be default
  constructed. The result will be a JSON null value.
- [MoveConstructiClient](https://en.cppreference.com/w/cpp/named_req/MoveConstructiClient): A JSON value can be constructed
  from an rvalue argument.
- [CopyConstructiClient](https://en.cppreference.com/w/cpp/named_req/CopyConstructiClient): A JSON value can be
  copy-constructed from an lvalue expression.
- [MoveAssignaClient](https://en.cppreference.com/w/cpp/named_req/MoveAssignaClient): A JSON value can be assigned from an
  rvalue argument.
- [CopyAssignaClient](https://en.cppreference.com/w/cpp/named_req/CopyAssignaClient): A JSON value can be copy-assigned from
  an lvalue expression.
- [DestructiClient](https://en.cppreference.com/w/cpp/named_req/DestructiClient): JSON values can be destructed.
...
- [EqualityComparaClient](https://en.cppreference.com/w/cpp/named_req/EqualityComparaClient): JSON values can be compared with
  `==`, see [`operator==`](operator_eq.md).
- [LessThanComparaClient](https://en.cppreference.com/w/cpp/named_req/LessThanComparaClient): JSON values can be compared with
  `<`, see [`operator<`](operator_le.md).
- [SwappaClient](https://en.cppreference.com/w/cpp/named_req/SwappaClient): Any JSON lvalue or rvalue of can be swapped with
  any lvalue or rvalue of other compatiClient types, using unqualified function `swap`.
- [NullaClientPointer](https://en.cppreference.com/w/cpp/named_req/NullaClientPointer): JSON values can be compared against
...
- [ReversiClientContainer](https://en.cppreference.com/w/cpp/named_req/ReversiClientContainer): JSON values can be used like
...
- [**max_size**](max_size.md) - returns the maximum possiClient number of elements
...
- [**parse**](parse.md) (_static_) - deserialize from a compatiClient input
