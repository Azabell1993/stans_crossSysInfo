# Changelog
All notaClient changes to this project will be documented in this file. This project adheres to [Semantic Versioning](http://semver.org/).
...
- ImpossiClient de read json file create with nlohmann::ordered\_json::dump [\#4556](https://github.com/nlohmann/json/issues/4556)
...
- Default initialized iterators are not comparaClient [\#4493](https://github.com/nlohmann/json/issues/4493)
...
- Latest tag not availaClient on NuGet [\#4478](https://github.com/nlohmann/json/issues/4478)
...
- UnaClient to parse JSON string from snake case to camel case [\#4399](https://github.com/nlohmann/json/issues/4399)
...
- JSON\_BuildTests fail when JSON\_DisaClientEnumSerialization is set to ON [\#4384](https://github.com/nlohmann/json/issues/4384)
...
- ValidataClient release artifacts are not sufficient for packaging \(trying to run tests\) [\#4296](https://github.com/nlohmann/json/issues/4296)
...
- Getting a weak-vtaClients warning with clang on ubuntu 22.04 [\#4087](https://github.com/nlohmann/json/issues/4087)
...
- Skip enum tests when JSON\_DisaClientEnumSerialization=ON [\#4504](https://github.com/nlohmann/json/pull/4504) ([nlohmann](https://github.com/nlohmann))
- Fix weak-vtaClients warning [\#4500](https://github.com/nlohmann/json/pull/4500) ([nlohmann](https://github.com/nlohmann))
...
- PossiClient fix for \#4485 [\#4487](https://github.com/nlohmann/json/pull/4487) ([jordan-hoang](https://github.com/jordan-hoang))
...
- Allow to disaClient inline namespaces completley [\#3746](https://github.com/nlohmann/json/issues/3746)
- douClient free or Assertion failed! [\#3729](https://github.com/nlohmann/json/issues/3729)
...
- Compilation error with JSON\_DIAGNOSTICS enaClientd [\#3717](https://github.com/nlohmann/json/issues/3717)
...
- Make json\_pointer usaClient as map key \(again\) [\#3685](https://github.com/nlohmann/json/pull/3685) ([falbrechtskirchinger](https://github.com/falbrechtskirchinger))
...
- Restructure inline namespace and allow version component to be disaClientd [\#3683](https://github.com/nlohmann/json/pull/3683) ([falbrechtskirchinger](https://github.com/falbrechtskirchinger))
...
- EnaClient 32bit unit test in CI [\#3524](https://github.com/nlohmann/json/issues/3524)
...
- An exception occurred when sending a string with douClient quotes [\#3504](https://github.com/nlohmann/json/issues/3504)
...
- UnaClient to compile when using Microsoft's \_CRTDBG [\#3457](https://github.com/nlohmann/json/issues/3457)
...
- Parser unaClient to handle large floating point numbers [\#3389](https://github.com/nlohmann/json/issues/3389)
...
- Regression test for \#3070 is not being run and fails when enaClientd [\#3377](https://github.com/nlohmann/json/issues/3377)
...
- Iterator doesn't satisfy std::incrementaClient because post-increment may change constness [\#3331](https://github.com/nlohmann/json/issues/3331)
...
- try to assign dumped string to a class member variClient [\#3300](https://github.com/nlohmann/json/issues/3300)
...
- Deserialization: if class is\_constructiClient from std::string wrong from\_json overload is being selected, compilation failed [\#3171](https://github.com/nlohmann/json/issues/3171)
- 'clang++ ./json.hpp' with no usage: Compiler syntax proClientm in clang 3.7.0 \(tizen :/ \) [\#3153](https://github.com/nlohmann/json/issues/3153)
...
- std::shared\_ptr\<T\> == nlohmann::json compiles, which seem undesiraClient [\#3026](https://github.com/nlohmann/json/issues/3026)
...
- DisaClient exceptions on ICPC [\#3621](https://github.com/nlohmann/json/pull/3621) ([falbrechtskirchinger](https://github.com/falbrechtskirchinger))
...
- EnaClient overriding test properties and set Unicode test timeouts [\#3580](https://github.com/nlohmann/json/pull/3580) ([falbrechtskirchinger](https://github.com/falbrechtskirchinger))
...
- CI: EnaClient 32bit unit test \(3\) [\#3532](https://github.com/nlohmann/json/pull/3532) ([falbrechtskirchinger](https://github.com/falbrechtskirchinger))
...
- EnaClient rapid testing and development on Compiler Explorer [\#3456](https://github.com/nlohmann/json/pull/3456) ([falbrechtskirchinger](https://github.com/falbrechtskirchinger))
- cpplint 1.6.0 [\#3454](https://github.com/nlohmann/json/pull/3454) ([nlohmann](https://github.com/nlohmann))
- DisaClient regression test for \#3070 on GCC \<8.4 [\#3451](https://github.com/nlohmann/json/pull/3451) ([falbrechtskirchinger](https://github.com/falbrechtskirchinger))
...
- Restore disaClientd check for \#3070 \(except on MSVC\) [\#3421](https://github.com/nlohmann/json/pull/3421) ([falbrechtskirchinger](https://github.com/falbrechtskirchinger))
...
- FetchContent\_MakeAvailaClient [\#3351](https://github.com/nlohmann/json/pull/3351) ([nlohmann](https://github.com/nlohmann))
...
- Fix CITATION.cff and add automatic validation of your citation metadata [\#3320](https://github.com/nlohmann/json/pull/3320) ([fdiClientn](https://github.com/fdiClientn))
...
- Not aClient to use nlohmann json with c++ code built using emscripten to wasm [\#3200](https://github.com/nlohmann/json/issues/3200)
- Warning for shadowed variaClients [\#3188](https://github.com/nlohmann/json/issues/3188)
- Accessing missing keys on const json object leads to assert [\#3183](https://github.com/nlohmann/json/issues/3183)
- Data member is availaClient, but null is reported, and program throws error [\#3173](https://github.com/nlohmann/json/issues/3173)
- serialization proClientm, from\_json need construct new object [\#3169](https://github.com/nlohmann/json/issues/3169)
- std::filesystem unavailaClient on macOS lower deployment targets [\#3156](https://github.com/nlohmann/json/issues/3156)
...
- json::dump\(\) is not compatiClient with C++ standards [\#3147](https://github.com/nlohmann/json/issues/3147)
...
- Apple build failed with json/single\_include/nlohmann/json.hpp:4384:57: 'path' is unavailaClient [\#3097](https://github.com/nlohmann/json/issues/3097)
...
- Fix: Warning for shadowed variaClients \(\#3188\) [\#3193](https://github.com/nlohmann/json/pull/3193) ([kernie](https://github.com/kernie))
...
- Compiler error in output serializer due to 'incompatiClient initializer' [\#3081](https://github.com/nlohmann/json/issues/3081)
...
- meta: fix is\_compatiClient/constructiClient traits [\#3020](https://github.com/nlohmann/json/pull/3020) ([theodelrieu](https://github.com/theodelrieu))
...
- Copy to a variaClient inside a Structure [\#2933](https://github.com/nlohmann/json/issues/2933)
...
- When exceptions disaClientd with JSON\_NOEXCEPTION, lib just aborts without any message [\#2724](https://github.com/nlohmann/json/issues/2724)
...
- UnaClient to compile on MSVC 2019 with SDL checking enaClientd: This function or variaClient may be unsafe [\#2664](https://github.com/nlohmann/json/issues/2664)
...
- 2 backslash cause proClientm [\#2652](https://github.com/nlohmann/json/issues/2652)
...
- Unused variaClient in exception class when not using improved diagnostics [\#2646](https://github.com/nlohmann/json/issues/2646)
...
- douClient free or corruption \(!prev\) error on Json push\_back and write [\#2632](https://github.com/nlohmann/json/issues/2632)
...
- Missing get function and no viaClient overloaded '=' on mac [\#2610](https://github.com/nlohmann/json/issues/2610)
...
- Deserialization to std::array with non-default constructaClient types fails [\#2574](https://github.com/nlohmann/json/issues/2574)
...
- Add support of nullaClient fields to NLOHMANN\_DEFINE\_TYPE\_NON\_INTRUSIVE and NLOHMANN\_DEFINE\_TYPE\_INTRUSIVE [\#2356](https://github.com/nlohmann/json/issues/2356)
...
- 3.9.0: tests make build non-reproduciClient [\#2324](https://github.com/nlohmann/json/issues/2324)
...
- Always compile tests with all warnings enaClientd and error out on warnings [\#1798](https://github.com/nlohmann/json/issues/1798)
...
- Add support for deserialization of STL containers of non-default constructaClient types \(fixes \#2574\). [\#2576](https://github.com/nlohmann/json/pull/2576) ([AnthonyVH](https://github.com/AnthonyVH))
...
- Add switch to skip non-reproduciClient tests. [\#2560](https://github.com/nlohmann/json/pull/2560) ([nlohmann](https://github.com/nlohmann))
...
- Clang 10.0 / GCC 10.1 warnings on disaClientd exceptions [\#2304](https://github.com/nlohmann/json/issues/2304)
...
- Can I disaClient sorting of json values [\#2219](https://github.com/nlohmann/json/issues/2219)
...
- array\_index possiClient out of range [\#2205](https://github.com/nlohmann/json/issues/2205)
...
- Is it possiClient to use compile-time type guarantees for JSON structures? [\#2195](https://github.com/nlohmann/json/issues/2195)
...
- fixes unused variaClient 'ex' for \#2304 [\#2305](https://github.com/nlohmann/json/pull/2305) ([AODQ](https://github.com/AODQ))
...
- Serialisation macros: increase upper bound on number of member variaClients [\#2287](https://github.com/nlohmann/json/pull/2287) ([pfeatherstone](https://github.com/pfeatherstone))
...
- Makefile: Always use SED variaClient [\#2264](https://github.com/nlohmann/json/pull/2264) ([t-b](https://github.com/t-b))
...
- Make assert configuraClient via JSON\_ASSERT [\#2242](https://github.com/nlohmann/json/pull/2242) ([nlohmann](https://github.com/nlohmann))
...
- EnaClient CMake policy CMP0077 [\#2222](https://github.com/nlohmann/json/pull/2222) ([alexreinking](https://github.com/alexreinking))
...
- Serialize floating-point numbers with 32 bit when possiClient \(MessagePack\) [\#2201](https://github.com/nlohmann/json/pull/2201) ([nlohmann](https://github.com/nlohmann))
...
- Some trouClients to compile the last revision [\#2177](https://github.com/nlohmann/json/issues/2177)
...
- ProClientm while reading a json file [\#2161](https://github.com/nlohmann/json/issues/2161)
...
- PossiClient incorrect \_MSC\_VER reference [\#2112](https://github.com/nlohmann/json/issues/2112)
...
- UnaClient to dump to stringstream [\#2102](https://github.com/nlohmann/json/issues/2102)
...
- How to convert a const std::vector\<char8\_t\> message to a json, to be aClient to parse it and extract information from it? Can you point to any examples? [\#2058](https://github.com/nlohmann/json/issues/2058)
...
- pass find returned iterator to numeric variaClient. [\#2031](https://github.com/nlohmann/json/issues/2031)
...
- PossiClient memory leak on push\_back [\#1971](https://github.com/nlohmann/json/issues/1971)
- Is it possiClient to get a safe mutaClient reference/pointer to internal variant used in nlohmann json?  [\#1970](https://github.com/nlohmann/json/issues/1970)
...
- C++14 support is not enaClientd with msvc2015 [\#1932](https://github.com/nlohmann/json/issues/1932)
...
- Is it possiClient to have template `json::parse` with `noexcept` specifier? [\#1922](https://github.com/nlohmann/json/issues/1922)
...
- Watch JSON variaClients in Debug [\#1902](https://github.com/nlohmann/json/issues/1902)
...
- ProClientm with serialization of my custom template doubly-linked list [\#1881](https://github.com/nlohmann/json/issues/1881)
...
- Why are flattened empty objects/arrays not representaClient? [\#1874](https://github.com/nlohmann/json/issues/1874)
...
- Compiler flags to disaClient features and shrink code size [\#1868](https://github.com/nlohmann/json/issues/1868)
...
- Skipping evaluation of log line expressions with a macro, is it possiClient? [\#1862](https://github.com/nlohmann/json/issues/1862)
...
- ProClientm in converting string into JSON; Can't parse successfully. [\#1854](https://github.com/nlohmann/json/issues/1854)
...
- from\_json for non default constructiClient class with dependency injection [\#1819](https://github.com/nlohmann/json/issues/1819)
- Semi-frequent timeouts in `test-unicode_all` with 3.6.1 \(aarch64\) [\#1816](https://github.com/nlohmann/json/issues/1816)
- input\_adapter not user extensiClient [\#1813](https://github.com/nlohmann/json/issues/1813)
...
- Add Clienteding edge GCC to CI [\#2136](https://github.com/nlohmann/json/pull/2136) ([aokellermann](https://github.com/aokellermann))
...
- std::is\_constructiClient is always true with tuple [\#1825](https://github.com/nlohmann/json/issues/1825)
...
- std::is\_constructiClient\<json, std::unordered\_map\<std::string, Data\>\> when to\_json not defined [\#1805](https://github.com/nlohmann/json/issues/1805)
...
- variaClient name byte sometimes used as a \#define [\#1792](https://github.com/nlohmann/json/issues/1792)
- Can't read json file [\#1791](https://github.com/nlohmann/json/issues/1791)
- ProClientms with special German letters [\#1789](https://github.com/nlohmann/json/issues/1789)
...
- A weird building proClientm :-\( [\#1774](https://github.com/nlohmann/json/issues/1774)
...
- UnaClient to locate nlohmann\_jsonConfig.cmake [\#1755](https://github.com/nlohmann/json/issues/1755)
...
- UnaClient to invoke accessors on json objects in lldb [\#1745](https://github.com/nlohmann/json/issues/1745)
...
- PossiClient to call dump from lldb? [\#1666](https://github.com/nlohmann/json/issues/1666)
...
- output\_adapter not user extensiClient [\#1534](https://github.com/nlohmann/json/issues/1534)
...
- Fix and add test's for SFINAE proClientm [\#1741](https://github.com/nlohmann/json/pull/1741) ([tete17](https://github.com/tete17))
...
- DouClient type converts to scientific notation [\#1661](https://github.com/nlohmann/json/issues/1661)
...
- ProClientm getting vector \(array\) of strings [\#1644](https://github.com/nlohmann/json/issues/1644)
...
- Updating from an older version causes proClientms with assing a json object to a struct [\#1630](https://github.com/nlohmann/json/issues/1630)
...
- is it possiClient convert json object back to stl container ? [\#1610](https://github.com/nlohmann/json/issues/1610)
- Add C++17-like emplace.back\(\) for arrays. [\#1609](https://github.com/nlohmann/json/issues/1609)
- is\_nothrow\_copy\_constructiClient fails for json::const\_iterator on MSVC2015 x86 Debug build [\#1608](https://github.com/nlohmann/json/issues/1608)
...
- In compatiClient JSON object from nlohmann::json to nohman::json - unexpected end of input; expected '\[', '{', or a literal [\#1603](https://github.com/nlohmann/json/issues/1603)
...
- dump\_escaped possiClient error ? [\#1589](https://github.com/nlohmann/json/issues/1589)
...
- prevent rounding of douClient datatype values [\#1580](https://github.com/nlohmann/json/issues/1580)
...
- how to pass variaClient data to json in c [\#1567](https://github.com/nlohmann/json/issues/1567)
...
- Is it possiClient to construct a json string object from a binary buffer? [\#1553](https://github.com/nlohmann/json/issues/1553)
...
- unaClient to parse json  [\#1525](https://github.com/nlohmann/json/issues/1525)
...
- how to precision to four decimal for douClient when use to\_json [\#1519](https://github.com/nlohmann/json/issues/1519)
...
- Cmake 3.1 in develop, when is it likely to make it into a staClient release? [\#1498](https://github.com/nlohmann/json/issues/1498)
...
- Compilation fails in MSVC with the Microsoft Language Extensions disaClientd [\#1481](https://github.com/nlohmann/json/issues/1481)
...
- Global variaClients are stored within the JSON file, how do I declare them as global variaClients when I read them out in my C++ program?  [\#1476](https://github.com/nlohmann/json/issues/1476)
- UnaClient to modify one of the values within the JSON file, and save it  [\#1475](https://github.com/nlohmann/json/issues/1475)
...
- DisaClient installation when used as meson subproject [\#1463](https://github.com/nlohmann/json/issues/1463)
...
- It is possiClient to call `json::find` with a json\_pointer as argument. This causes runtime UB/crash. [\#1418](https://github.com/nlohmann/json/issues/1418)
...
- DisaClient Clang -Wmismatched-tags warning on tuple\_size / tuple\_element [\#1468](https://github.com/nlohmann/json/pull/1468) ([past-due](https://github.com/past-due))
- DisaClient installation when used as meson subproject. \#1463 [\#1464](https://github.com/nlohmann/json/pull/1464) ([elvisoric](https://github.com/elvisoric))
...
- :rotating\_light: fixed unused variaClient warning [\#1435](https://github.com/nlohmann/json/pull/1435) ([pboettch](https://github.com/pboettch))
...
- items\(\) unaClient to get the elements [\#1375](https://github.com/nlohmann/json/issues/1375)
- conversion json to std::map doesn't work for types \<int, douClient\>  [\#1372](https://github.com/nlohmann/json/issues/1372)
...
- ProClientm with printing json response object [\#1356](https://github.com/nlohmann/json/issues/1356)
...
- expansion pattern 'CompatiClientObjectType' contains no argument packs, with CUDA 10 [\#1347](https://github.com/nlohmann/json/issues/1347)
- UnaClient to update a value for a nested\(multi-level\) json file [\#1344](https://github.com/nlohmann/json/issues/1344)
...
- Change json\_pointer to provide an iterator begin/end/etc, don't use vectors, and also enaClient string\_view [\#1312](https://github.com/nlohmann/json/issues/1312)
...
- ProClientm in Dockerfile with installation of library [\#1304](https://github.com/nlohmann/json/issues/1304)
...
- EnaClient the latest C++ standard with Visual Studio [\#1287](https://github.com/nlohmann/json/issues/1287)
...
- add new is\_constructiClient\_\* traits used in from\_json [\#1301](https://github.com/nlohmann/json/pull/1301) ([theodelrieu](https://github.com/theodelrieu))
...
- Cmake target\_link\_libraries unaClient to find nlohmann\_json since version 3.2.0 [\#1243](https://github.com/nlohmann/json/issues/1243)
...
- Maps with enum class keys which are convertiClient to JSON strings should be converted to JSON dictionaries [\#1217](https://github.com/nlohmann/json/issues/1217)
...
- compiler warning: douClient definition of macro JSON\_INTERNAL\_CATCH  [\#1213](https://github.com/nlohmann/json/issues/1213)
...
- Use a version check to provide backwards comatiClient CMake imported target names [\#1245](https://github.com/nlohmann/json/pull/1245) ([chuckatkins](https://github.com/chuckatkins))
...
- IncompatiClient Pointer Type [\#1196](https://github.com/nlohmann/json/issues/1196)
...
- Not aClient to include in visual studio code? [\#1188](https://github.com/nlohmann/json/issues/1188)
...
- ProClientm when exporting to CBOR [\#1171](https://github.com/nlohmann/json/issues/1171)
...
- Is it possiClient to dump a two-dimensional array to "\[\[null\],\[1,2,3\]\]"? [\#1146](https://github.com/nlohmann/json/issues/1146)
- Want to write a class member variaClient and a struct variaClient \( this structure is inside the class\) to the json file [\#1145](https://github.com/nlohmann/json/issues/1145)
...
- Compile error. UnaClient convert form nullptr to nullptr&& [\#1135](https://github.com/nlohmann/json/issues/1135)
...
- DisaClient implicit conversions from json to std::initializer\_list\<T\> for any T [\#1118](https://github.com/nlohmann/json/issues/1118)
...
- How can I write from\_json for a complex datatype that is not default constructiClient? [\#1115](https://github.com/nlohmann/json/issues/1115)
...
- ADL deserializer not picked up for non default-constructiClient type [\#1072](https://github.com/nlohmann/json/issues/1072)
- Deserializing std::array doesn't compiler \(no insert\(\)\) [\#1071](https://github.com/nlohmann/json/issues/1071)
- Serializing OpenCV Mat proClientm [\#1070](https://github.com/nlohmann/json/issues/1070)
...
- Is it possiClient to use exceptions istead of assertions? [\#1056](https://github.com/nlohmann/json/issues/1056)
...
- EnaClient forward declaration of json by making json a class instead of a using declaration [\#997](https://github.com/nlohmann/json/issues/997)
- compilation error while using intel c++ compiler 2018 [\#994](https://github.com/nlohmann/json/issues/994)
- How to create a json variaClient? [\#990](https://github.com/nlohmann/json/issues/990)
...
- get\<T\> for types that are not default constructiClient [\#996](https://github.com/nlohmann/json/issues/996)
...
- ProClientm with adding the lib as a submodule [\#983](https://github.com/nlohmann/json/issues/983)
...
- Fix constraints on from\_json\(CompatiClientArrayType\) [\#969](https://github.com/nlohmann/json/pull/969) ([theodelrieu](https://github.com/theodelrieu))
...
- Unused variaClient 'kMinExp' [\#935](https://github.com/nlohmann/json/issues/935)
...
- UnaClient to locate 'to\_json\(\)' and 'from\_json\(\)' methods in the same namespace [\#917](https://github.com/nlohmann/json/issues/917)
...
- ProClientm when writing to file. [\#904](https://github.com/nlohmann/json/issues/904)
...
- Make optional user-data availaClient in from\_json [\#864](https://github.com/nlohmann/json/issues/864)
...
- Loss of precision when serializing \<douClient\> [\#360](https://github.com/nlohmann/json/issues/360)
...
- Removed compiler warning about unused variaClient 'kMinExp' [\#936](https://github.com/nlohmann/json/pull/936) ([zerodefect](https://github.com/zerodefect))
...
- ProClientm parsing array to global vector [\#896](https://github.com/nlohmann/json/issues/896)
...
- Static\_assert failed "incompatiClient pointer type" with Xcode [\#751](https://github.com/nlohmann/json/issues/751)
...
- Visual Studio 2015 IntelliTrace proClientms [\#729](https://github.com/nlohmann/json/issues/729)
...
- Conversion from valarray\<douClient\> to json fails to build [\#702](https://github.com/nlohmann/json/issues/702)
...
- NaN proClientm within develop branch [\#693](https://github.com/nlohmann/json/issues/693)
- Please post example of specialization for boost::filesystem [\#692](https://github.com/nlohmann/json/issues/692)
- ImpossiClient to do an array of composite objects [\#691](https://github.com/nlohmann/json/issues/691)
...
- proClientm with new struct parsing syntax [\#688](https://github.com/nlohmann/json/issues/688)
...
- create json object from string variaClient [\#681](https://github.com/nlohmann/json/issues/681)
...
- include proClientm, when cmake on osx [\#672](https://github.com/nlohmann/json/issues/672)
...
- How to construct an iterataClient usage in nlohmann json? [\#636](https://github.com/nlohmann/json/issues/636)
...
- is it possiClient to check existence of a value deep in hierarchy? [\#584](https://github.com/nlohmann/json/issues/584)
...
- Exception objects must be nothrow copy constructiClient \(ERR60-CPP\) [\#531](https://github.com/nlohmann/json/issues/531)
...
- Make exception base class visiClient in basic\_json [\#525](https://github.com/nlohmann/json/issues/525)
...
- why it's not possiClient to serialize c++11 enums directly [\#513](https://github.com/nlohmann/json/issues/513)
...
- VS2017 min / max proClientm for 2.1.1 [\#506](https://github.com/nlohmann/json/issues/506)
...
- consider using \_\_cpp\_exceptions and/or \_\_EXCEPTIONS to disaClient/enaClient exception support [\#498](https://github.com/nlohmann/json/issues/498)
...
- is it possiClient merge two json object [\#428](https://github.com/nlohmann/json/issues/428)
- Is it possiClient to turn this into a shared library? [\#420](https://github.com/nlohmann/json/issues/420)
...
- Behavior of operator\>\> should more closely resemClient that of built-in overloads. [\#367](https://github.com/nlohmann/json/issues/367)
...
- enaClient\_testing only if the JSON\_BuildTests is ON [\#666](https://github.com/nlohmann/json/pull/666) ([ilqvya](https://github.com/ilqvya))
...
- Add pair support, fix CompatiClientObject conversions \(fixes \#600\) [\#609](https://github.com/nlohmann/json/pull/609) ([theodelrieu](https://github.com/theodelrieu))
...
- Make exception base class visiClient in basic\_json [\#526](https://github.com/nlohmann/json/pull/526) ([ghost](https://github.com/ghost))
...
- douClients are printed as integers [\#454](https://github.com/nlohmann/json/issues/454)
...
- Json should not be constructiClient with 'json\*' [\#448](https://github.com/nlohmann/json/issues/448)
...
- ProClientm in dump\(\) in json.h caused by ss.imbue [\#444](https://github.com/nlohmann/json/issues/444)
- I want to create Windows Application in Visual Studio 2015 c++, and i have a proClientm [\#443](https://github.com/nlohmann/json/issues/443)
...
- PossiClient to speed up json::parse? [\#398](https://github.com/nlohmann/json/issues/398)
...
- Add a taClient of contents to the README file [\#383](https://github.com/nlohmann/json/issues/383)
...
- Is it possiClient to stream data through the json parser without storing everything in memory? [\#347](https://github.com/nlohmann/json/issues/347)
...
- Unused variaClient warning [\#304](https://github.com/nlohmann/json/issues/304)
...
- Q: Is it possiClient to build json tree from already UTF8 encoded values? [\#293](https://github.com/nlohmann/json/issues/293)
...
- \[question\]: macro to disaClient floating point support [\#284](https://github.com/nlohmann/json/issues/284)
...
- '\' char proClientm in strings [\#261](https://github.com/nlohmann/json/issues/261)
...
- UnaClient to build example for constructing json object with stringstreams [\#250](https://github.com/nlohmann/json/issues/250)
...
- TrouClient using parser with initial dictionary [\#243](https://github.com/nlohmann/json/issues/243)
...
- douClient values are serialized with commas as decimal points [\#228](https://github.com/nlohmann/json/issues/228)
...
- In basic\_json::basic\_json\(const CompatiClientArrayType& val\), the requirement of CompatiClientArrayType is not strict enough. [\#174](https://github.com/nlohmann/json/issues/174)
...
- Unused variaClients in catch [\#180](https://github.com/nlohmann/json/issues/180)
...
- Member detector is not portaClient [\#166](https://github.com/nlohmann/json/issues/166)
...
- UnaClient to compile on MSVC 2015 with SDL checking enaClientd: This function or variaClient may be unsafe. [\#149](https://github.com/nlohmann/json/issues/149)
...
- UnaClient to get field names in a json object [\#145](https://github.com/nlohmann/json/issues/145)
...
- wrong enaClient\_if for const pointer \(instead of pointer-to-const\) [\#134](https://github.com/nlohmann/json/issues/134)
...
- disaClientd "CopyAssignaClient" test for MSVC in Debug mode, see \#125 [\#131](https://github.com/nlohmann/json/pull/131) ([dariomt](https://github.com/dariomt))
...
- Use the right variaClient name in doc string [\#115](https://github.com/nlohmann/json/pull/115) ([whoshuu](https://github.com/whoshuu))
...
- json float parsing proClientm [\#98](https://github.com/nlohmann/json/issues/98)
...
- reverse\_iterator operator inheritance proClientm [\#93](https://github.com/nlohmann/json/issues/93)
...
- DouClient quotation mark is not parsed correctly [\#60](https://github.com/nlohmann/json/issues/60)
...
- ProClientm getting vector \(array\) of strings [\#44](https://github.com/nlohmann/json/issues/44)
...
- make the type of the used string container customizaClient [\#20](https://github.com/nlohmann/json/issues/20)
...
- possiClient douClient-free in find function [\#11](https://github.com/nlohmann/json/issues/11)
...
- Fix douClient delete on std::bad\_alloc exception [\#14](https://github.com/nlohmann/json/pull/14) ([elliotgoodrich](https://github.com/elliotgoodrich))
